                ...
                <table class="table table-striped table-bordered table-hover" id="sample_2">
                  ...
                  <tbody>
                    <?php if (!empty($empaccess)){
                      ...
                      <td><a data-id="<?php echo $empaccesses['id'] ;?>" data-empid="<?php echo $empaccesses['emp_id'] ;?>" data-empname="<?php echo $empaccesses['emp_name'] ;?>" data-empmobile="<?php echo $empaccesses['emp_mobile']; ?>" href="#" class="popupDynamic" ><i class="fa fa-pencil-square-o"></i></a></td>
                      </tr>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <div class="form-group">
            <label for="usr"> Employee Name </label>
            <input type="text" maxlength="30" disabled required class="form-control" id="empname">
          </div>
          <div class="form-group">
            <label for="usr"> Employee Mobile No. </label>
    ...
    $(document).ready(function(){
      ...
      $("#submit_form").click(function(){
        ...
        if (empmobile == '') {
          ...
          $('#empmobile').focus();
          $('.invalid-feedback').text('Please enter employee mobile no.');
          return false;
        }
        else if(empmobile.length < 10){
          $('.invalid-feedback').fadeIn();
          $('#empmobile').focus();
          $('.invalid-feedback').text('Please enter 10-digit mobile no.');
        }
        else{
          $('.invalid-feedback').hide();
