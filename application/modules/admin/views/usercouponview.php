...
<head>
 ...
 <!-- BEGIN CONTENT -->
        ...
        <div class="page-content">
          ...
          <li>
          <span> <a href="<?php echo base_url('admin/customer'); ?>" >Discount List</a>
          <i class="fa fa-angle-right"></i>
          </span>
          </li>
          <li>
          <span>Create Customer Wise Discount</span>
          </li>
          </ul>
          </div>
          <div class="content">
                            ...
                            <div class="portlet light bordered">
                                <div class="portlet-title">
                                    <div class="caption">
                                        ...
                                        <span class="caption-subject font-dark sbold uppercase">Create Promo Code  for  -- <?php echo isset($usercoupon->name1) ? $usercoupon->name1 : $name1?> (<?php echo isset($usercoupon->customer_code) ? $usercoupon->customer_code  : $customer_code?>)</span>
                                    </div>
                                    
                                </div>
                                <div class="portlet-body form">
                                    <form class="form-horizontal" action="<?php echo base_url('/admin/usercoupon/updatecoupon'); ?>" method="post" role="form">
                                      <input type="hidden" name="user_id" value="<?php echo isset($usercoupon->uid) ? $usercoupon->uid : $customer_code?>">
                                      <input type="hidden" name="user_auto_id" value="<?php echo isset($usercoupon->aid) ? $usercoupon->aid : ''?>">
                                        <div class="form-body">
                                            
                                            <div class="form-group">
                                                <label class="col-md-3 control-label">User name</label>
                                                <div class="col-md-9">
                                                    <p class="form-control-static"> <?php echo isset($usercoupon->name1) ? $usercoupon->name1 : $name1?> </p>
                                                </div>
                                            </div>
                                                ...
                                                <div class="col-md-9">
                                                    <div class="input-group">
                                                        ...
                                                        <span class="input-group-btn">
                                                            <button id="gencoupon" data-id="<?php echo isset($usercoupon->uid) ? $usercoupon->uid : ''?>" class="btn btn-success" type="button">
