            ...
            <!-- BEGIN EXAMPLE TABLE PORTLET-->
                            <div class="portlet box red">
                                <div class="portlet-title">
                                    <div class="caption">
                                        <i class="fa fa-globe"></i>Machine Models Master Data</div>
                                    ...
                                    <table class="table table-striped table-bordered table-hover" id="sample_2">
                                        ...
                                        <?php 
                                          ...
                                          if(!empty($machine_model)){
                                            ...
                                            foreach ($machine_model as $key=>$value) {?>
                                              ...
                                              <tr>
                                                ...
                                                <td><?php echo   $value['industry_div'] ;?></td>
                                                <td><?php echo   $value['business_grp'] ;?> </td>
