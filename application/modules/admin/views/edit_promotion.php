...
<div class="page-content-wrapper">
                ...
                <div class="page-content">
                  ...
                  <div class="alert-danger fade in alert-dismissable">  <?php echo $CI->session->flashdata('error') ?> </div>
                  <?php }?>
                                ...
                                <div class="portlet light form-fit bordered">
                                    <div class="portlet-title">
                                        <div class="caption">
                                            ...
                                            <span class="caption-subject font-green sbold uppercase">Edit Promotion</span>
                                        </div>
                                        <div class="actions">
                                            <div class="">
                                            </div>
                                    ...
                                    <div class="portlet-body form">
                                        ...
                                        <div class="form-horizontal form-bordered">
                                            <div class="form-body">
                                                ...
                                                <form class="" action="<?php echo base_url('/admin/promotion/update_promotion'); ?>" method="post" role="form" enctype="multipart/form-data">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-7">
                                                            <div class="input-group date date-picker" data-date-format="yyyy-mm-dd" data-date-start-date="+1d">
                                                                ...
                                                                value="<?php echo isset($promo->from_date) ? $promo->from_date : ''?>" required onkeypress="return false;">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-7">
                                                            <div class="input-group date date-picker" data-date-format="yyyy-mm-dd" data-date-start-date="+1d">
                                                                ...
                                                                value="<?php echo isset($promo->to_date) ? $promo->to_date : ''?>" required onkeypress="return false;">
                                                                <span class="input-group-btn">
                                                                    <button class="btn default" type="button">
                                                                        <i class="fa fa-calendar"></i>
                                                                    </button>
                                                        ...
                                                        <div class="col-md-9">
                                                            ...
                                                            <div class="fileinput fileinput-new" data-provides="fileinput">
                                                                <div class="fileinput-new thumbnail" style="width: 200px; height: 150px;">
                                                                        ...
                                                                        <?php echo '<img src="data:image/jpeg;base64,'.base64_encode($promo->offer_image ).'" />' ?>
