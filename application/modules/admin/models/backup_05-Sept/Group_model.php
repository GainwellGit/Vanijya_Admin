...
class Group_model extends CI_Model {
	...
	public function getgroupcoupon($groupid) 
	{
		...
		$this->db->select('material_group.group_code as uid,material_group.group_description,discount_detail.discount_value,discount_detail.min_ammount,discount_detail.from_date,discount_detail.to_date,discount_detail.promocode,discount_detail.is_delete,discount_type.type');
		$this->db->from('material_group');
