...
$page = end($link_array);
$uervalue=array("customer","Usercoupon","location","material_group",'group','zone','history');
            ...
            <div class="page-sidebar-wrapper">
                ...
                <div class="page-sidebar navbar-collapse collapse">
                    ...
                    <!--     <li class="sidebar-toggler-wrapper hide"> -->
                        ...
                        <li class="nav-item <?php echo (!empty(array_intersect($uervalue,$link_array)))?'active':'';?> ">
                       ...
                       <?php $a1=array("edit_mapping","add_mapping","create_mapping"); ?>
                        ...
                        <li class="nav-item <?php echo (!empty(array_intersect($order,$link_array)))?'active':'';?>">
                            <a href="<?php echo base_url('aadmin/history/order'); ?>" class="nav-link ">
                                        <i class="fa fa-puzzle-piece"></i>
